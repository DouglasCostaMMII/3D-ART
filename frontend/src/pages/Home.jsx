        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20 lg:py-24">
          <div className="flex flex-col items-center text-center sm:items-start sm:text-left max-w-2xl">
            ...
            <p className="text-indigo-100 text-base sm:text-lg lg:text-xl leading-relaxed max-w-xl">
              ...
              <span className="text-cyan-300 font-medium">direto do estúdio para você</span>.
              Design, qualidade e personalização em cada camada.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-3 mt-8">
              ...
              <a
                href={`https://wa.me/5548998118661`}
                target="_blank"
            ...
            <div className="flex flex-wrap gap-6 mt-10 text-indigo-100">
              <div className="text-center sm:text-left">
                ...
                <p className="text-xs text-indigo-200 uppercase tracking-wide">Personalizado</p>
              </div>
              <div className="text-center sm:text-left">
                <p className="text-2xl font-bold text-white">PLA</p>
                <p className="text-xs text-indigo-200 uppercase tracking-wide">Alta Qualidade</p>
              </div>
              <div className="text-center sm:text-left">
                <p className="text-2xl font-bold text-white">48h</p>
                <p className="text-xs text-indigo-200 uppercase tracking-wide">Entrega Rápida</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div id="produtos">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 pb-2">
          ...
          <p className="text-gray-500 mt-1 text-sm sm:text-base">
            Cada peça é impressa sob demanda com máxima qualidade
          </p>
        </div>
        <ProductGrid />
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-2">
              <IsoCube size={28} />
              <div>
                <p className="text-white font-bold text-sm">3D Studio - Impressões</p>
                <p className="text-gray-500 text-xs">Impressão 3D sob demanda</p>
              </div>
            </div>
            <div className="text-center sm:text-right">
              <p className="text-xs">
                &copy; {new Date().getFullYear()} 3D Studio - Impressões. Todos os direitos reservados.
              </p>
              <a
                href={`https://wa.me/5548998118661`}
                target="_blank"
                rel="noopener noreferrer"
                className="text-emerald-400 hover:text-emerald-300 text-xs mt-0.5 inline-block"
              >
                (48) 99811-8661
              </a>
            </div>
